...
public class LinkedMegaBlock {
   ...
   * returns "RED A -> "
   * 
   * @return String - a String representation of this Linked MegaBlock object
   */
  @Override
  public String toString() {
    if (next != null)
      return block.toString() + " -> ";// creates " -> " inbetween normal tostrings
    else
      return block.toString() + " -> END"; // if no connect, add a " -> END" to show no its done
  }
}
